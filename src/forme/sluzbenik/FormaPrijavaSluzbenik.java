...
FormaPrijaviSe fps;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Prijava sluzbenik"));
    ...
    private void btnPrijaviSeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrijaviSeActionPerformed
        ...
        if(username.isEmpty() || password.isEmpty()){
            JOptionPane.showMessageDialog(this, "Unesite username i password!");
        }
        String[] niz = {username,password};
        KlijentskiZahtev kz = new KlijentskiZahtev(Operacije.DA_LI_JE_REGISTROVAN_SLUZBENIK, niz);
        KomunikacijaSaServerom.getInstance().posaljiKZ(kz);
        ServerskiOdgovor so = KomunikacijaSaServerom.getInstance().prihvatiSO();
        System.out.println(so.getOdgovor());
        ...
        fps.setVisible(false);
            ...
            JOptionPane.showMessageDialog(this, so.getPoruka()+" Preostalo pokusaja: " + brojac);
        }
